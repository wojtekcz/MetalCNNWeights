...
arg_parser.add_argument('--input-dir',      default='./input_cars',      help='Directory to download model [%(default)s]')
arg_parser.add_argument('--output-dir',     default='./output_cars',     help='Directory to generate weights and biases [%(default)s]')
...
def main():
    ...
    # ----- LOAD
    graph_create(os.path.join(input_dir, 'retrained_graph_v4.pb'))
